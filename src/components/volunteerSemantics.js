  ...
  return (
    <div style={containerStyle}>
      ...
      <p className="text-lg mb-6">
        We're constantly looking for passionate individuals to join our team in
        various roles:
      </p>
      <ul className="list-disc list-inside text-left mb-8">
        <li className={`${styles.boldItalicShadow}`}>
          Caretakers to ensure the youth are adequately managed and safety is
          ensured.
        </li>
        <li className={`${styles.boldItalicShadow}`}>
      ...
      <div className={`${styles.volunteerIcons}`}>
        ...
        <img
          ...
          alt="Caretaker Icon"
          className={`${styles.volunteerIcon} ${styles.iconGlow}`}
        />
        <img
