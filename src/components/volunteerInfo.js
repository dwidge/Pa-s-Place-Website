...
const VolunteerInfo = () => {
  return (
    <div
      className={`${styles.container} flex flex-col items-center justify-center w-full`}
    >
      <div className="flex flex-row justify-around items-start w-full max-w-6xl mt-8">
        <div
          className={`${styles.howToVolunteer} flex flex-col items-center w-1/2`}
        >
        ...
        <div className="flex flex-col items-center w-1/2">
          ...
          <div className="flex flex-wrap justify-around items-start mb-6 w-full">
            <ul className="list-disc list-inside text-left max-w-md">
              <li className={styles.boldItalicShadow}>
                Caretakers to ensure the youth are adequately managed and safety
                is ensured.
              </li>
              <li className={styles.boldItalicShadow}>
                Activity coordinators to provide fun and enrichment
              </li>
              <li className={styles.boldItalicShadow}>
                Caterers to prepare nutritious meals
              </li>
              <li className={styles.boldItalicShadow}>
                Maintenance helpers to keep our facilities in top shape
              </li>
              <li className={styles.boldItalicShadow}>
                Administrative assistants to help with daily operations
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className={styles.volunteerIcons}>
        <img
          src={caretakerIcon.src}
          alt="Caretaker Icon"
          className={`${styles.volunteerIcon} ${styles.iconGlow} ${styles.bounce1}`}
        />
        <img
          src={actCoOrdIcon.src}
          alt="Activity Coordinator Icon"
          className={`${styles.volunteerIcon} ${styles.iconGlow} ${styles.bounce2}`}
        />
        <img
          src={cateryIcon.src}
          alt="Caterer Icon"
          className={`${styles.volunteerIcon} ${styles.iconGlow} ${styles.bounce3}`}
        />
        <img
          src={maintenancyIcon.src}
          alt="Maintenance Icon"
          className={`${styles.volunteerIcon} ${styles.iconGlow} ${styles.bounce4}`}
        />
        <img
          src={adminIcon.src}
          alt="Admin Icon"
          className={`${styles.volunteerIcon} ${styles.iconGlow} ${styles.bounce5}`}
        />
      </div>
    </div>
  );
